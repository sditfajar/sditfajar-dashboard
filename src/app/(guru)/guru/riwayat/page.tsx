...
export default function RiwayatBulananPage() {
  ...
  // Use eachDayOfInterval to generate the list of days to show in the table
  const allDays = eachDayOfInterval({ start: monthStart, end: monthEnd }).reverse();
              ...
              <TableBody>
                {isLoading ? (
                  ...
                  allDays.map((day) => {
                    ...
                    // Hide days in the future for the current month
